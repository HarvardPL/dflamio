...
\NewDocumentCommand{\notactsforquery}{mommm}{
#1 \IfNoValueTF{#2}{\centernot\vdash}{\centernot\vdash_{#2}} #3 \actsfor #4 \IfNoValueOrEmptyTF{#5}{}{: #5}
}
...
\NewDocumentCommand{\gstepstos}{ O{} O{} O{*} }{{\xRightarrow[#1]{\mathmakebox[1.4em]{#2}}{}\!\!^{#3}}}
