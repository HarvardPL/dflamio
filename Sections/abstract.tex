\begin{abstract}
Applications that handle sensitive information need to express and reason about the trust relationships between security principals. This is difficult because the trust relationships are dynamic, and must thus be reasoned about at run time, when discovering and reasoning about trust relationships might inadvertently reveal confidential information and be subject to manipulation by untrusted principals. 
...
We have implemented \lang{} as a Haskell library, and proved that an adequate \lang{} calculus enforces a noninterference-based security guarantee. We have implemented several case studies, demonstrating the expressiveness and usefulness of \lang{} in distributed settings, as well as our novel approach for fine-grained control of label creep.
\end{abstract}