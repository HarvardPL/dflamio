...
Along with the efficient query resolution algorithm, additional layers of caching to avoid repeated network communication. %\TODO{Something about external timing channels being outside the scope of our work?}
