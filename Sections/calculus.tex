...
\begin{figure}
    ...
    \and
    \inferrule[Fwd]{\flowstoquery{\Assumps; n; \env}{\env_n . \lblkw}{\conf{m}}{\level_1} \\\\ \actsforquery{\Assumps; m; \extend{\env}{m}{\extend{\env_m}{\strategy}{\env_n.\strategy}}}{p}{q}{\level_2} }{\actsforquery{\Assumps; n; \env}{p}{q}{\level_1 \join \level_2}}
    \end{mathpar}
