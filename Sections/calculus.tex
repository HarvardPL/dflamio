...
\begin{figure}
    ...
    \begin{tabular}{l}
         ...
         \mid \graybox{\resetstrategy{\overline{p}}{\expr}} \mid \graybox{\resetTolabeled{p}{q}{\expr}} \mid \graybox{\resetscope{\scope}{\expr}}
         \end{aligned}$ \\
         $\begin{aligned}[t]
...
((*@$\lambda^{\mathsf{Alice}}$@*) _ . [...]
  let g = ((*@$\lambda^{\mathsf{Bob}}_{(\conf{\bot} \conj \integ{\mathsf{Bob}})}$@*) f .
              bref := new (*@$\integ{\mathsf{Bob}}$@*) true
              withScope (
                assume (*@$\conf{\mathsf{Alice}}$@*) (*@$\actsfor$@*) (*@$\conf{\mathsf{Bob}}$@*) @ (*@$\integ{\mathsf{Bob}}$@*)
                return ((*@$\lambda^{\mathsf{Alice}}_{(\conf{\bot} \conj \integ{\mathsf{Alice}})}$@*) x . 
                           b <- !bref
                           bref := false
...
\and
\inferrule[T-Abs]{\hastype{m; \tenv, x : \type_1}{\expr}{\liotype{\type_2}} \\\\ \type = \func{\type_1}{\liotype{(\labeled{\type_2})}}}{\hastype{n; \tenv}{\abs{p}{\lb{p}{\type_2}}{x}{\expr}}{\type}}
\and
