...
\begin{figure}
    ...
    \end{mathpar}
    \caption{Auxiliary judgment for using delegations when proving an acts for query in \lang. The meta-variable $C$ abbreviates $\Assumps; n; \env$.}
